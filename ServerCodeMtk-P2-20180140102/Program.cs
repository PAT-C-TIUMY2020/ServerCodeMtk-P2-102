...
namespace ServerCodeMtk_P2_20180140102
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                //Service Runtime Player                 
                smb.HttpGetEnabled = true; 
                //untuk mengaktifkan wsdl (dibuka saat development, tidak untuk dibuka)                 
            ...
            catch (Exception ex) { hostObj = null; Console.WriteLine(ex.Message); Console.ReadLine(); }
        }
    }
}
